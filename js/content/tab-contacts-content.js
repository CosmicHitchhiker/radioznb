document.write(`
  <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam sit amet erat convallis, porta elit eu, vehicula odio. Donec augue purus, aliquam non cursus in, condimentum at ex. Aliquam vitae vulputate nulla, in pretium ligula. Integer feugiat justo vel aliquet aliquet. Donec fringilla ultricies purus eu eleifend. Vestibulum eleifend elit vel pharetra gravida. Suspendisse et nulla dapibus ligula ornare facilisis vel vel nulla. Ut turpis sem, ultrices quis scelerisque feugiat, luctus eu risus. Suspendisse dapibus ipsum ut sodales accumsan. Proin quam est, sodales vitae lorem vel, tristique pretium ante. Aliquam eget gravida arcu, ut lobortis augue. Sed lobortis ipsum sed felis commodo aliquet. Donec et metus tellus. Nullam sit amet ante sit amet odio posuere congue at sit amet leo. Integer aliquam viverra nisl interdum commodo.</p>
      ...
      <div class="contacts-demobutts-submenu">
        <a href="https://vk.com/znb_radio" target="_blank" class="contacts-demobutts-button contacts-demobutts-round">
          <img border="0" alt="VK" src="images/vk.png">
        </a>
        <a href="https://www.facebook.com/100780934922627/" target="_blank" class="contacts-demobutts-button contacts-demobutts-round">
          <img border="0" alt="FB" src="images/fb.png">
        </a>
      </div>

    <a href="https://teleg.run/radiochata" target="_blank" class="contacts-demobutts-button contacts-demobutts-long">
        <img border="0" alt="TG_chat" src="images/chat.png">
      </a>
      <div class="contacts-demobutts-submenu">
        <a href="https://teleg.run/radi0ZnB" target="_blank" class="contacts-demobutts-button contacts-demobutts-round">
          <img border="0" alt="TG" src="images/tg.png" border="0">
        </a>
        <a href="http://c18.radioboss.fm/playlist/158/stream.m3u" target="_blank" class="contacts-demobutts-button contacts-demobutts-round">
          <img alt="M3U_player" src="images/m3u.png" border="0">
        </a>
      </div>
